...
export function ShopSection() {
  ...
  const features = [{
    icon: Truck,
    text: "Spedizione automatica"
  }, {
    icon: CreditCard,
    text: "Pagamenti Stripe/PayPal"
  }, {
    icon: Package,
  ...
  return <section className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          return <Card key={index} className="p-6 bg-card/50 backdrop-blur border-border/50 hover:bg-card/70 transition-all duration-300 group">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <ul className="space-y-1">
                      {category.products.map((product, idx) => <li key={idx} className="text-sm text-muted-foreground flex items-center">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          ...
          return <div key={index} className="flex items-center justify-center space-x-3 bg-card/30 rounded-lg p-4">
