...
export function ProductsDigital() {
  ...
  return (
    <section id="prodotti-digitali" className="py-20 bg-gradient-to-b from-background to-muted/20">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <Badge variant="outline" className="mb-4">Prodotti Digitali</Badge>
          ...
          <p className="text-xl text-muted-foreground leading-relaxed">
            ...
            creati da professionisti qualificati.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-hero p-8 rounded-2xl text-white max-w-2xl mx-auto">
            <Users className="w-12 h-12 mx-auto mb-4" />
            <h3 className="text-2xl font-bold mb-4">Consulenza Personalizzata</h3>
            <p className="mb-6 opacity-90">
              Vuoi un programma completamente su misura? Prenota una consulenza 1-on-1 
